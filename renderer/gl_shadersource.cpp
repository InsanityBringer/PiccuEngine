...
"		color = vec4(outcolor.rgb, texture(colortexture, outuv.xy).a);\n"
"	#elif defined(USE_TEXTURING) && defined(USE_LIGHTMAP)\n"
"		color = texture(colortexture, outuv.xy) * texture(lightmaptexture, outuv2.xy) * outcolor;\n"
"	#elif defined(USE_TEXTURING)\n"
"		color = texture(colortexture, outuv.xy) * outcolor;\n"
"	#else\n"
"		color = outcolor;\n"
"	#endif\n"
"}\n"
